...
<section id="prodetails" class="section-p1">
    <div class="single-pro-image">
        <img src="img/montre_femme_classique.jpg" width="100%" id="MainImg" alt="">
    </div>
    ...
    <div class="single-pro-details">
        ...
        <p>Capturant la lumière du jour, notre montre en or rose avec cadran diamanté est une ode à l'élégance intemporelle. Chaque battement de cœur une symphonie en or et en diamant.</p>
    </div>
</section>
