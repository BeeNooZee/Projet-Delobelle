...
<section id="prodetails" class="section-p1">
    <div class="single-pro-image">
        <img src="img/montre_homme_classique.jpg" width="100%" id="MainImg" alt="">
    </div>
    ...
    <div class="single-pro-details">
        ...
        <p>
            Découvrez l'essence de l'horlogerie française avec ce joyaux argenté. Élégante et sophistiquée, cette montre incarne l'alliance parfaite entre tradition et innovation. </p>
    </div>
</section>
